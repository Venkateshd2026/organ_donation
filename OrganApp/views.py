...
one={
    'from':'0xef36C7fB76761fd95A58802B915241516098633d'
}
...
def readDetails(contract_type):
    ...
    deployed_contract_address = '0xef36C7fB76761fd95A58802B915241516098633d' #hash address to access Organ contract
...
def saveDataBlockChain(currentData, contract_type):
    ...
    deployed_contract_address = '0xef36C7fB76761fd95A58802B915241516098633d' #contract address
    with open(compiled_contract_path) as file:
        contract_json = json.load(file)  # load contract info as JSON
        contract_abi = contract_json['abi']  # fetch contract's abi - necessary to call its functions
    file.close()
...
sender_email="venki.cse.rymec@gmail.com"
app_passwordd="fzinnbvgwihhkzom"
...
def AddDonorHistoryAction(request):
    if request.method == 'POST':
        ...
        try:
            ...
            print(f"❎ Sorry Email is Not {e.__str__}")
...
def AddPatientHistoryAction(request):
    if request.method == 'POST':
        ...
        msg.set_content(body)
        try:
            # with smtplib.SMTP_SSL('smtp.gmail.com',465)as smtp:y
            with smtplib.SMTP_SSL('smtp.gmail.com',465)as smtp:
                smtp.login(sender_email,app_passwordd)
                smtp.send_message(msg)
            print("✅ Email Sent")
